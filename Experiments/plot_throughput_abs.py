...
def plot_results(default_start, default_end, spike_start, spike_end):
    ...
    ax.plot_surface(x_index, y_index, v2 ,cmap = cm.Blues, linewidth=0, antialiased=False)
    ax.plot_surface(x_index, y_index, v1, cmap = cm.Reds, linewidth=0, antialiased=False)
    plt.savefig("throughput_abs")
