...
def plot_results(default_start, default_end, spike_start, spike_end):
    ...
    ax.plot_surface(x_index, y_index, ratio_nogc, cmap=cm.Blues, linewidth=0, antialiased=False)
    ax.plot_surface(x_index, y_index, ratio_withgc,cmap=cm.Reds, linewidth=0, antialiased=False)
    
    plt.show()
    
    
if __name__ == "__main__":
    plot_results(2,11,6,21)